<x-filament-panels::page>
    <div wire:poll.8s class="space-y-5">
        <x-filament.ui.hero
            tone="slate"
            ...
            <div class="mt-3 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div class="nova-mini-stat">
                    ...
                    @if ($stalePendingCount > 0)
                        <p class="nova-mini-stat-description">{{ $stalePendingCount }} beyond {{ $lagThresholdMinutes }}m threshold.</p>
                    @endif
                </div>
                <div class="nova-mini-stat">
                    ...
                    <div class="space-y-3">
                        @foreach ($generatingItems as $item)
                            <article class="rounded-2xl border border-sky-200 p-4 dark:border-sky-800/40">
                                ...
                                <div class="mt-4 h-1.5 overflow-hidden rounded-full bg-sky-100 dark:bg-sky-900/30">
